...
def schedule_jobs(pt_list, dd_list, n, scheduling_method, job_name):
    if scheduling_method == 'FCFS':
        return fcfo(pt_list, dd_list, n, job_name)
    elif scheduling_method == 'SPT':
        return spt(pt_list, dd_list, n, job_name)
    elif scheduling_method == 'LPT':
        return lpt(pt_list, dd_list, n, job_name)
    elif scheduling_method == 'Smallest Slack':
        return smallest_slack(pt_list, dd_list, n, job_name)
    elif scheduling_method == 'Smallest Criticality Ratio':
        return smallest_critical_ratio(pt_list, dd_list, n, job_name)
    else:
